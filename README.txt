...
An example of how ajax works with php & pdo 
...
For the FlatFile version you have to change Permission on the Folder & File to these setting in order to write the file on your host server:

chmod -R 777

chmod -R 755

For the database version you have to created a database called ‘emails’and upload the 'ajax,sql' file to your database to create the table so you can insert the email address into the database. 
